...
export declare class Client {
   ...
   */
  ask(query: string, sources: Array<string | Source>, filter?: query.LogicalExpression, mode?: Mode, selectFields?: Array<string>): Promise<AskResult>
  /**
   ...
   */
  search(query: string, sources: Array<string | Source>, topK: number, filter?: query.LogicalExpression, selectFields?: Array<string>): Promise<Array<ContextSearchResult>>
}
...
export declare class DatasetClient {
  ...
  upsertFile(docId: string, input: FileInput, metadata: Record<string, any>): Promise<HandleResponse>
...
export declare namespace data {
  ...
  export const enum MatrixValueType {
    F32 = 'f32',
    F16 = 'f16',
    F8 = 'f8',
    U8 = 'u8',
...
export declare namespace query {
  ...
  /** @ignore */
  export const enum TernaryOperator {
    Choose = 'choose',
...
export declare namespace schema {
  ...
  export const enum EmbeddingDataType {
    Float32 = 'float32',
    UInt8 = 'uint8',
    Binary = 'binary'
  }
  ...
  export const enum KeywordIndexType {
    Text = 'text'
  }
  /**
  ...
  export const enum ListValueType {
    Text = 'text',
    Integer = 'integer',
    Float = 'float'
  }
  ...
  export const enum MultiVectorDistanceMetric {
    Maxsim = 'maxsim'
  }
  /**
  ...
  export const enum MultiVectorQuantization {
    Binary1bit = '1bit',
    Binary2bit = '2bit',
    Scalar = 'scalar'
  }
