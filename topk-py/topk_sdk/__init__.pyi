...
class AsyncClient:
    ...
    def ask(
        ...
        filter: typing.Optional[query.LogicalExpr] = None,
        effort: typing.Optional[typing.Literal["low", "medium", "high"]] = None,
    ) -> typing.Awaitable[dict[builtins.str, typing.Any]]:
        """
    ...
    def ask_stream(
        ...
        filter: typing.Optional[query.LogicalExpr] = None,
        effort: typing.Optional[typing.Literal["low", "medium", "high"]] = None,
    ) -> typing.AsyncIterator[dict[builtins.str, typing.Any]]:
        """
...
class DatasetClient:
    ...
    def upsert_file(
        ...
        input: typing.Union[builtins.str, typing.IO[builtins.bytes], typing.Any],
...
class AskIterator:
    ...
    def __next__(self) -> typing.Optional[dict[builtins.str, typing.Any]]: ...
...
class AsyncAskIterator:
    ...
    def __anext__(self) -> typing.AsyncIterator[dict[builtins.str, typing.Any]]: ...
