...
class FunctionExpr:
    ...
    *Internal*
    ...
    def mul(self, other: Numeric) -> LogicalExpr: ...
    def div(self, other: Numeric) -> LogicalExpr: ...
    def coalesce(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def min(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float, builtins.str]) -> LogicalExpr: ...
    def max(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float, builtins.str]) -> LogicalExpr: ...
    def is_null(self) -> LogicalExpr: ...
    def is_not_null(self) -> LogicalExpr: ...
    def abs(self) -> LogicalExpr: ...
    def ln(self) -> LogicalExpr: ...
    ...
    def __abs__(self) -> LogicalExpr: ...
    def choose(self, x: FlexibleExpr, y: FlexibleExpr) -> LogicalExpr: ...
    def boost(self, condition: FlexibleExpr, boost: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __eq__(self, other: FlexibleExpr) -> LogicalExpr: ...  # type: ignore[override]
    def __ne__(self, other: FlexibleExpr) -> LogicalExpr: ...  # type: ignore[override]
    def __lt__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float, builtins.str]) -> LogicalExpr: ...
    def __le__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float, builtins.str]) -> LogicalExpr: ...
    def __gt__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float, builtins.str]) -> LogicalExpr: ...
    def __ge__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float, builtins.str]) -> LogicalExpr: ...
    def __add__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __radd__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __sub__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __rsub__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __mul__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __rmul__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __truediv__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
    def __rtruediv__(self, other: typing.Union[LogicalExpr, builtins.int, builtins.float]) -> LogicalExpr: ...
