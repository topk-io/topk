...
class LogicalExpr(Enum):
    ...
    def pow(self, other: Numeric) -> LogicalExpr: ...
    def __pow__(self, other: Numeric, modulo: typing.Optional[Numeric] = None) -> LogicalExpr: ...
    def __rpow__(self, other: Numeric, modulo: typing.Optional[Numeric] = None) -> LogicalExpr: ...
