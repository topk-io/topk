...
@pytest.mark.asyncio
async def test_async_upsert_to_non_existent_collection(async_ctx: AsyncProjectContext):
    with pytest.raises(error.CollectionNotFoundError):
        await async_ctx.client.collection("missing").upsert([{"_id": "one"}])


@pytest.mark.asyncio
async def test_async_upsert_basic(async_ctx: AsyncProjectContext):
...
@pytest.mark.asyncio
async def test_async_upsert_batch(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(async_ctx.scope("test"), schema={})
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_upsert_sequential(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(async_ctx.scope("test"), schema={})
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_upsert_no_documents(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(async_ctx.scope("test"), schema={})
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_upsert_invalid_document(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(async_ctx.scope("test"), schema={})
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_upsert_schema_validation(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"), schema={"name": schema.text().required()}
    )
    async_collection = async_ctx.client.collection(collection.name)
...
async def test_async_upsert_primitives(async_ctx: AsyncProjectContext, params):
    value, data_type = params  # type: ignore

    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
...
@pytest.mark.asyncio
async def test_async_upsert_with_bytes_helper(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test-bytes"),
        schema={
...
@pytest.mark.asyncio
async def test_async_upsert_vectors(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
        schema={
...
@pytest.mark.asyncio
async def test_async_upsert_sparse_vectors(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
        schema={
...
@pytest.mark.asyncio
async def test_async_upsert_empty_float_list(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
...
@pytest.mark.asyncio
async def test_async_upsert_empty_float_list_with_helper(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
        schema={"f32_list": schema.list(value_type="float")},
    )
...
@pytest.mark.asyncio
async def test_async_upsert_empty_integer_list_raises_error(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
...
@pytest.mark.asyncio
async def test_async_upsert_empty_integer_list_with_helper(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
        schema={"i32_list": schema.list(value_type="integer")},
    )
...
@pytest.mark.asyncio
async def test_async_upsert_empty_string_list_raises_error(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
...
@pytest.mark.asyncio
async def test_async_upsert_empty_string_list_with_helper(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(
        async_ctx.scope("test"),
        schema={"string_list": schema.list(value_type="text")},
    )
...
@pytest.mark.asyncio
async def test_async_get_from_non_existent_collection(async_ctx: AsyncProjectContext):
    with pytest.raises(error.CollectionNotFoundError):
        await async_ctx.client.collection("missing").get(["doc1"])


@pytest.mark.asyncio
async def test_async_get_non_existent_document(async_ctx: AsyncProjectContext):
...
@pytest.mark.asyncio
async def test_async_get_document(async_ctx: AsyncProjectContext):
    collection = await dataset.books.setup_async(async_ctx)
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_get_multiple_documents(async_ctx: AsyncProjectContext):
    collection = await dataset.books.setup_async(async_ctx)
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_get_document_fields(async_ctx: AsyncProjectContext):
    collection = await dataset.books.setup_async(async_ctx)
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_delete_from_non_existent_collection(async_ctx: AsyncProjectContext):
    async_collection = async_ctx.client.collection("missing")
    with pytest.raises(error.CollectionNotFoundError):
...
@pytest.mark.asyncio
async def test_async_delete_non_existent_document(async_ctx: AsyncProjectContext):
    collection = await async_ctx.client.collections().create(async_ctx.scope("test"), schema={})
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_query_select_literal(async_ctx: AsyncProjectContext):
    collection = await dataset.books.setup_async(async_ctx)
...
@pytest.mark.asyncio
async def test_async_collection_all_operations(async_ctx: AsyncProjectContext):
    collection = await dataset.books.setup_async(async_ctx)
    async_collection = async_ctx.client.collection(collection.name)
...
@pytest.mark.asyncio
async def test_async_collection_all_operations_with_consistency(async_ctx: AsyncProjectContext):
    collection = await dataset.books.setup_async(async_ctx)
    async_collection = async_ctx.client.collection(collection.name)
