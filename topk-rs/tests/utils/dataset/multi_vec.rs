...
pub fn cast(dt: MatrixValueType, matrix: Matrix) -> Matrix {
    match matrix.values {
        Some(matrix::Values::F32(v)) => match dt {
            MatrixValueType::F32 => Matrix::new(matrix.num_rows, matrix.num_cols, v.values),
...
pub fn docs(dt: MatrixValueType) -> Vec<Document> {
    ...
    vec![
        doc!(
            ...
            "token_embeddings" => cast(dt, Matrix::new(2, 7, vec![
        ...
        doc!(
            ...
            "token_embeddings" => cast(dt, Matrix::new(1, 7, vec![
        ...
        doc!(
            ...
            "token_embeddings" => cast(dt, Matrix::new(3, 7, vec![
        ...
        doc!(
            ...
            "token_embeddings" => cast(dt, Matrix::new(4, 7, vec![
