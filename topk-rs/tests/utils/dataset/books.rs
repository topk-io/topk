...
pub fn schema() -> HashMap<String, FieldSpec> {
    schema!(
        ...
        "summary_embedding" => FieldSpec::f32_vector(19, true, VectorDistanceMetric::Euclidean),
        "nullable_embedding" => FieldSpec::f32_vector(13, false, VectorDistanceMetric::Euclidean),
        "scalar_embedding" => FieldSpec::u8_vector(16, false, VectorDistanceMetric::Euclidean),
        "scalar_i8_embedding" => FieldSpec::i8_vector(97, false, VectorDistanceMetric::Euclidean),
...
pub fn docs() -> Vec<Document> {
    ...
    vec![
        doc!(
            ...
            "summary_embedding" => vec![1.0; 19],
            "nullable_embedding" => vec![1.0; 13],
            ...
            "scalar_i8_embedding" => Value::list(vec![-100i8; 97]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![2.0; 19],
            "nullable_embedding" => vec![2.0; 13],
            "scalar_embedding" => Value::list(vec![2u8; 16]),
            "scalar_i8_embedding" => Value::list(vec![-50i8; 97]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![3.0; 19],
            "scalar_i8_embedding" => Value::list(vec![0i8; 97]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![5.0; 19],
            "nullable_embedding" => vec![5.0; 13],
        ...
        doc!(
            ...
            "summary_embedding" => vec![8.0; 19],
            "nullable_embedding" => vec![8.0; 13],
