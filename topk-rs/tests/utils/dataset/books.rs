...
pub fn docs() -> Vec<Document> {
    ...
    vec![
        doc!(
            ...
            "summary_embedding" => vec![1.0f32; 16],
            "nullable_embedding" => vec![1.0f32; 16],
            "scalar_embedding" => Value::list(vec![1u8; 16]),
            "binary_embedding" => Value::list(vec![0u8, 1]),
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![0, 1, 2], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![2.0f32; 16],
            "nullable_embedding" => vec![2.0f32; 16],
            "scalar_embedding" => Value::list(vec![2u8; 16]),
            "binary_embedding" => Value::list(vec![0u8, 3]),
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![2,3,4], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![3.0f32; 16],
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![3, 4, 5], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![4.0f32; 16],
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![4, 5, 6], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![5.0f32; 16],
            "nullable_embedding" => vec![5.0f32; 16],
            "scalar_embedding" => Value::list(vec![5u8; 16]),
            "binary_embedding" => Value::list(vec![0u8, 7]),
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![5, 6, 7], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![6.0f32; 16],
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![6,7,8], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![7.0f32; 16],
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![7,8,9], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![8.0f32; 16],
            "nullable_embedding" => vec![8.0f32; 16],
            "scalar_embedding" => Value::list(vec![8u8; 16]),
            "binary_embedding" => Value::list(vec![0u8, 15]),
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![8,9,10], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![9.0f32; 16],
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![9,10,11], vec![1.0f32, 2.0, 3.0]),
        ...
        doc!(
            ...
            "summary_embedding" => vec![10.0f32; 16],
            "sparse_f32_embedding" => Value::f32_sparse_vector(vec![10,11,12], vec![1.0f32, 2.0, 3.0]),
