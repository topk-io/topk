...
pub fn docs() -> Vec<Document> {
    ...
    vec![
        doc!(
            ...
            "sparse_f32_embedding" => Value::sparse_vector(vec![0, 1, 2], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![0, 1, 2], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![0, 1, 2], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "scalar_i8_embedding" => Value::list(vec![-50i8; 4]),
            "binary_embedding" => Value::list(vec![0u8, 3]),
            "sparse_f32_embedding" => Value::sparse_vector(vec![2,3,4], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![2,3,4], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![2,3,4], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "scalar_i8_embedding" => Value::list(vec![0i8; 4]),
            "sparse_f32_embedding" => Value::sparse_vector(vec![3, 4, 5], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![3, 4, 5], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![3, 4, 5], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "scalar_i8_embedding" => Value::list(vec![50i8; 4]),
            "sparse_f32_embedding" => Value::sparse_vector(vec![4, 5, 6], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![4, 5, 6], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![4, 5, 6], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "sparse_f32_embedding" => Value::sparse_vector(vec![5, 6, 7], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![5, 6, 7], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![5, 6, 7], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "sparse_f32_embedding" => Value::sparse_vector(vec![6,7,8], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![6,7,8], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![6,7,8], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "sparse_f32_embedding" => Value::sparse_vector(vec![7,8,9], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![7,8,9], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![7,8,9], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "sparse_f32_embedding" => Value::sparse_vector(vec![8,9,10], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![8,9,10], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![8,9,10], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "scalar_i8_embedding" => Value::list(vec![-100i8; 4]),
            "sparse_f32_embedding" => Value::sparse_vector(vec![9,10,11], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![9,10,11], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![9,10,11], vec![1u8, 2, 3]),
        ...
        doc!(
            ...
            "sparse_f32_embedding" => Value::sparse_vector(vec![10,11,12], vec![1.0, 2.0, 3.0]),
            "sparse_f8_embedding" => Value::sparse_vector(vec![10,11,12], vec![F8E4M3::from(1.0), F8E4M3::from(2.0), F8E4M3::from(3.0)]),
            "sparse_u8_embedding" => Value::sparse_vector(vec![10,11,12], vec![1u8, 2, 3]),
