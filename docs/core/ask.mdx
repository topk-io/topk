...
Facts in the answer are associated with one or more citations. Citations are **numbered**. Each fact includes a `ref_ids` list, whose values correspond to keys in the `refs`.
