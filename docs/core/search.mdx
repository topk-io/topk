...
Search returns a list of the most relevant Search Results based on the provided query. Search Results are individual passages parsed from the original documents
...
| `content_id` | `string` | A unique identifier for the content of this passage                                                                                               |
