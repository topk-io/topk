---
title: "Quickstart (5m)"
description: "Start using `topk` search database in under 5 minutes."
icon: "rocket"
---
...
```python Python
from topk_sdk.schema import text, int, f32_vector, vector_index
...
<Warning>
  ...
  If you want to guarantee that your writes are included in the query results, you can pass the `lsn` (log sequence number)
...
results = client.collection("books").query(
    select(
      "title",
      vector_distance=fn.vector_distance("title_embedding", [6.1, 7.2, 8.3, ...]),
