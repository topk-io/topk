  ...
  <Tab title="CLI" icon="terminal">
    <Steps>
      ...
      <Step title="Get your API key">
        ...
        ```
        <Tip>Get your API key from the [console here](https://console.topk.io/api-key).</Tip>
      </Step>
      <Step title="Upload a file">
        ```bash
        topk upload ./report.pdf --dataset quickstart --region aws-us-east-1-elastica -y
        ```

        The `--region` flag sets where your dataset is stored. See [available regions](/regions).
      </Step>
