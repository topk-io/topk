    ...
    <Steps>
      ...
      <Step title="Authenticate">
        ...
        <Info>
          ...
          You can also provide your API key via the `TOPK_API_KEY` environment variable:
    ...
    <Steps>
      ...
      <Step title="Ask a question">
        <CodeGroup>
          ...
          ```
          ```python Async
          answer = await client.ask("What was the total net income of Bank of America in 2024?", ["my-docs"])
