...
This guide will get you up and running with `topk` in under 5 minutes. You'll create a collection, add documents to it, and search using 
keywords, vectors, and filters in a single query.
