...
3. Learn how to use different searching techniques:
   - **Semantic search** (finding content by meaning)
   - **Keyword matching** (finding exact text)
...
First, create a `Client` instance with your [API key](/installation#api-key) and
