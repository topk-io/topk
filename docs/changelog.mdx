...
- **Docs & SDKs**: Published SDK reference for **Python** and **JavaScript** clients, and added detailed docstrings for a smoother developer experience.
...
- Added [`int8`](/documents/query#lt) vector support
