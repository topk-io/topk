...
In a multi-tenant setting, metadata filtering is used to narrow down the search space for a specific tenant by filtering documents based on the given tenant ID.
