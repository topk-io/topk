...
This design enables TopK to scale a single collection efficiently without performance degradation by leveraging
smart sharding by document ID.

However, this approach still enables you to query across all tenants if needed.
