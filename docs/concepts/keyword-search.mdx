...
TopK supports BM25 keyword search for your text fields.
...
Let's create a collection with a `title` and `description` text fields and add a keyword index to them:
