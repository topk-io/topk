...
description: "Combine multiple retrieval techniques within a single query"
---

TopK's True Hybrid Search allows you to run a query that combines multiple retrieval techniques such as:
