...
```python
struct(fields: Mapping[str, FieldSpecInput]) -> FieldSpec
```
...
| Parameter | Type |
| --------- | ---- |
| `fields` | Mapping[str, [`FieldSpecInput`](#fieldspecinput)] |
...
```python
FieldSpecInput = FieldSpec | Mapping[str, 'FieldSpecInput']
```

**Type**

[`FieldSpec`](#fieldspec) | Mapping[str, 'FieldSpecInput']
