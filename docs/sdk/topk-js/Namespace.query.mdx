...
| <a id="weight-1"></a> `weight?` | `number` | Weight for the term (defaults to 1.0) |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="all-1"></a> `all?` | `boolean` | Whether to match all terms |
| <a id="field-1"></a> `field?` | `string` | Field to match against |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="field-2"></a> `field?` | `string` | The field to match against. |
| <a id="token-1"></a> `token` | `string` | The token to match. |
| <a id="weight-2"></a> `weight` | `number` | The weight of the term. |
