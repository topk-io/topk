...
```ts
function groupBy(keys: Record<string, LogicalExpression>, aggs: Record<string, AggregateExpression>): Query;
```
...
| Parameter | Type |
| ------ | ------ |
| `value` | \| `string` \| `number` \| `boolean` \| `string`[] \| `number`[] \| `Date` \| [`List`](/sdk/topk-js/Namespace.data#list) |
...
```ts
function should(token: string, options?: ShouldOptions): TextExpression;
```
...
| ------ | ------ |
| `token` | `string` |
| `options?` | [`ShouldOptions`](/sdk/topk-js/Namespace.query#shouldoptions) |
...
```ts
datePart(part: DatePart): LogicalExpression;
```
...
| Parameter | Type |
| ------ | ------ |
| `part` | [`DatePart`](/sdk/topk-js/Namespace.query#datepart-1) |
...
elapsed(end: 
  | number
  | LogicalExpression, interval: Interval): LogicalExpression;
```
...
| Parameter | Type |
| ------ | ------ |
| `end` | \| `number` \| [`LogicalExpression`](/sdk/topk-js/Namespace.query#logicalexpression) |
| `interval` | [`Interval`](/sdk/topk-js/Namespace.query#interval) |
...
| Parameter | Type |
| ------ | ------ |
| `expr` | [`SortExpr`](/sdk/topk-js/Namespace.query#sortexpr)[] |
...
Use `.sort(expr, false).limit(k)` instead.
...
| ------ | ------ | ------ |
| <a id="property-all"></a> `all?` | `boolean` | Whether to match all terms |
| <a id="property-field"></a> `field?` | `string` | Field to match against |
| <a id="property-weight"></a> `weight?` | `number` | Weight for the match |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="property-token"></a> `token` | `string` | The token to match |
| <a id="property-weight-1"></a> `weight?` | `number` | Weight for the term (defaults to 1.0) |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="property-all-1"></a> `all?` | `boolean` | Whether to match all terms |
| <a id="property-field-1"></a> `field?` | `string` | Field to match against |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="property-field-2"></a> `field?` | `string` | Field to score against |
| <a id="property-weight-2"></a> `weight?` | `number` | Weight for the term |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="property-field-3"></a> `field?` | `string` | The field to match against. |
| <a id="property-token-1"></a> `token` | `string` | The token to match. |
| <a id="property-weight-3"></a> `weight` | `number` | The weight of the term. |
...
```ts
type Interval = "millisecond" | "second" | "minute" | "hour" | "day" | "week";
```
