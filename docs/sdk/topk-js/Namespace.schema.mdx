...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="dimension"></a> `dimension` | `number` | The dimension (number of columns) of the matrix |
| <a id="valuetype-1"></a> `valueType` | [`MatrixValueType`](/sdk/topk-js/Namespace.schema#matrixvaluetype) | The value type of the matrix elements |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="metric"></a> `metric` | `"maxsim"` | The distance metric to use for multi-vector similarity |
| <a id="quantization"></a> `quantization?` | [`MultiVectorQuantization`](/sdk/topk-js/Namespace.schema#multivectorquantization) | The quantization to use for multi-vector values |
| <a id="sketchbits"></a> `sketchBits?` | `number` | Number of bits to use for multi-vector sketch |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="metric-1"></a> `metric` | [`VectorDistanceMetric`](/sdk/topk-js/Namespace.schema#vectordistancemetric) | The distance metric to use for vector similarity |
...
| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="dimension-1"></a> `dimension` | `number` | The dimension of the vector |
