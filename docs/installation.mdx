...
<ParamField body="retry_config" type="RetryConfig">
  ...
  <Expandable title="properties">
    <ParamField body="max_retries" default="3" type="number">
      The maximum number of retries to attempt. Default is 3 retries.
    </ParamField>
    <ParamField body="timeout" default="30000" type="number">
    ...
    <ParamField body="backoff" type="BackoffConfig">
      ...
      <Expandable title="properties">
        <ParamField body="base" default="2" type="number">
          The base for the backoff. Default is 2x backoff.
        </ParamField>
        <ParamField body="init_backoff" default="100" type="number">
          The initial backoff in milliseconds. Default is 100 milliseconds.
        </ParamField>
        <ParamField body="max_backoff" default="10000" type="number">
