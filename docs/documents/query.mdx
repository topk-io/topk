...
The above example computes the cosine distance between the vector and the `title_embedding` field. The `title_embedding` field is a vector field that represents the title of the book.
