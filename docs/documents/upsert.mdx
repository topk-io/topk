...
client.collection("locations").upsert(
    [
        {"_id": "point-1", "vector": [0.12, 0.67, 0.82, 0.53], "payload": {"country": "Germany"}},
        {"_id": "point-2", "vector": [0.42, 0.53, 0.65, 0.33], "payload": {"country": "United Kingdom"}},
        {"_id": "point-3", "vector": [0.59, 0.33, 0.71, 0.61], "payload": {"country": "Russia"}},
        {"_id": "point-4", "vector": [0.03, 0.88, 0.79, 0.41], "payload": {"country": "United States"}},
        {"_id": "point-5", "vector": [0.31, 0.64, 0.29, 0.59], "payload": {"country": "China"}},
        {"_id": "point-6", "vector": [0.23, 0.14, 0.49, 0.91], "payload": {"country": "India"}},
    ]
)
```
