...
In TopK, a vector is represented as a flat array of numbers. To differentiate between various types of vectors, use provided data constructors when inserting or querying vectors:
