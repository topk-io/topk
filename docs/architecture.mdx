...
## Read Path
{/* Data Flow Diagram */}
<img src="/images/read-path-light.png" alt="Read Path" className="block dark:hidden" />
<img src="/images/read-path-dark.png" alt="Read Path" className="hidden dark:block" />
...
{/* Plan diagram */}
<img src="/images/topk-reactor-light.png" alt="Reactor" className="block dark:hidden" />
<img src="/images/topk-reactor-dark.png" alt="Reactor" className="hidden dark:block" />
...
## File Format (`.bob`)
`.bob` is our proprietary columnar file format designed from the ground up for search on object storage. It supports zero-copy/zero-decode I/O with type-specific containers for compressed dense and sparse vectors, tensors, inverted indices, and more.