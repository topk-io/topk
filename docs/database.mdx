...
It offers a robust search that includes semantic search, vector search, keyword (BM25) search, sparse vector search, multi-vector search, hybrid search, and more.
