---
title: "Get"
description: "Get documents stored in a collection by `_id`."
icon: "scan"
---

TopK collections store documents as key-value pairs. [`get()`](../sdk/topk-py#get) provides direct key-based lookup, similar to a key-value store.
