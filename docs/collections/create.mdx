...
This method is used to create both a **keyword** and a **vector** on a given field. This allows you to do both semantic search and keyword search over the same field. Note that `semantic_index()` can only be called over `text()` data type.
