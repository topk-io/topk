...
```python Python
"title_embedding": float_vector(dimension=1536)
```
...
```python Python
"title_embedding": byte_vector(dimension=1536)
```
...
```python Python
"title_embedding": vector(dimension=1536).index(vector_index(metric="euclidean"))
```
