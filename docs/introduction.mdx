...
<Steps>
  ...
  <Step title="Create your first collection">
    You can imagine collections as your database tables. Each collection can have its own schema and data. An example of a collection could a collection of movies or users.
  </Step>
